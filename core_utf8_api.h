...
SW_PUBL_API_IMPL inline SwUsz   swByteGetCodeptByteLenUtf8(SwU8 b) { return (b < 0xC0) ? 1 : swBitClz32((unsigned)(~b) << 24); }  // Continuation Byte is considered as byte len = 1
